...
export const LANDMARK_INFO: Record<string, { description: string; creatures: string[] }> = {
  ...
  'Natural Bridges': { description: 'A sea-carved sandstone arch rising from the surf at the west end of Santa Cruz. Each spring, the lupine-dotted bluffs behind the beach come alive with rare Mission Blue Butterflies, their iridescent wings flashing in the coastal sun.', creatures: ['🦋', '🦦', '🐚'] },
